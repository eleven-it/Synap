...
MPR_ALIASES: dict[str, str] = {
    ...
    "reserva-urgente-enviar": "3.2 Relación Reserva ↔ Urgente ↔ PED Urgente ↔ Enviar ↔ Fabricando",
    "32-relacion-reserva-urgente-ped-urgente-enviar-fabricando": "3.2 Relación Reserva ↔ Urgente ↔ PED Urgente ↔ Enviar ↔ Fabricando",
    "ejemplo-tablero": "3.3 Ejemplo didáctico (artículo componente)",
    "donde-modificar-reserva": "3.4 Dónde modificar la Reserva",
    "articulo-no-en-tablero": "3.5 Por qué un artículo no aparece en el tablero",
    "cambio-pedido-reserva-despues-enviar": "3.6 Si cambia el pedido o la reserva después de Enviar",
    "parte-produccion": "4. Parte de producción",
    "parte-supervisor": "4.1 Parte de producción (supervisor)",
    "sin-cupo-fabricando": "4.1.1 «Sin cupo Fabricando» (celdas deshabilitadas)",
