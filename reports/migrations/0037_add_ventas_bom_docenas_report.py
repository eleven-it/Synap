# Generated migration: Informe Ventas BOM en docenas
...
def delete_ventas_bom_docenas_report(apps, schema_editor):
    ...
    ReportDefinition.objects.filter(
        slug="ventas-bom-docenas", empresa__isnull=True
    ).delete()


class Migration(migrations.Migration):
    dependencies = [
        ("reports", "0036_add_ventas_marca_superart_report"),
    ]
    operations = [
