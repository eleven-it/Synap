...
**Documento**: `reports/docs/VALIDACION_VENTAS_NETAS.md`
...
### Documentación
- `reports/docs/VALIDACION_VENTAS_NETAS.md` → Validación vs VB6
- `reports/docs/CONTEXTO_TABLAS_VB6_INFORMES.md` → Contexto general
