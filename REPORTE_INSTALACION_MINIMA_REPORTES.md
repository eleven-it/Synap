...
- **Modelos necesarios:**
  - `Empresa` - Usado por `reports.models.ReportDefinition` y `reports_ai.models.ReportRequest`
...
### 5. **Reports AI** (`reports_ai`) - OPCIONAL
**Razón:** Sistema de reportes con IA (CrewAI)
- **Modelos:**
...
### 6. **AdministraNET Integration** (`administraNET_integration`) - REQUERIDO si se usa Reports AI
**Razón:** Conexión a base de datos MySQL de administraNET
- **Modelos:**
