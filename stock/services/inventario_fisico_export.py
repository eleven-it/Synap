...
def exportar_campana_xlsx(
    ...
    *,
    ...
    headers_lineas = [
        ...
        "Notas de crédito",
        "Ajustes inventario",
        "Otros mov. post-snapshot",
        "Ajuste sistema (total)",
        "Ajuste manual",
        "Override manual",
        "Mov. después del snapshot (efectivo)",
        "Stock teórico hoy",
        "Contado",
    ...
    for l in lineas:
        ...
        filas_lineas.append(
            (
                ...
                _num(ps.get("armado_mpr")),
                _num(ps.get("remitos")),
                _num(ps.get("facturas")),
                _num(ps.get("notas_credito")),
                _num(ps.get("ajustes")),
                _num(ps.get("otros")),
