...
class ExtractorsContratoTests(SimpleTestCase):
    ...
    def test_pd_es_vd_filtran_proveedor_cuando_no_es_todos(self):
        ...
        self.assertIn("CodigoProveedor", sql_pd)
        ...
        self.assertIn("CodigoProveedor", sql_es)
        ...
        self.assertIn("CodigoProveedor", sql_vd)
    ...
    def test_ci_solo_clientes_con_ventas(self):
        self.assertIn("WHERE cc.Codigo IS NOT NULL", ci._SQL)
