...
| [MANUAL_USUARIO_MPR.md](MANUAL_USUARIO_MPR.md) | **Manual de usuario** (flujo diario: tablero con Reserva/Urgente/**PED Urgente**/Fabricando/Enviar + ejemplos, parte, borrador CC, armado, imputación + configuración). Sin flujo OPT/OPP. |
...
| [AF_TRAZABILIDAD_MOVIMIENTOS_POR_ETAPA.md](AF_TRAZABILIDAD_MOVIMIENTOS_POR_ETAPA.md) | **Kardex pipeline:** saldos por etapa (Producción / Semi / 2.ª) + Qué pasó de parte (`Parte · turno · OPT · operario`, sin UUID). |
