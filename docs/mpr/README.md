...
| [MANUAL_USUARIO_MPR.md](MANUAL_USUARIO_MPR.md) | **Manual de usuario** del módulo MPR (flujo diario, OPT, trazabilidad máquina/línea, reportes). |
...
| [CARGA_MOVIL_OPERARIO.md](CARGA_MOVIL_OPERARIO.md) | Carga móvil del operario (`/mpr/mi-parte/`), buscador, aprobación supervisor. |
