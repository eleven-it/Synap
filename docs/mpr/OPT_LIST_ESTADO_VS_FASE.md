...
| **Fase** (ahora **Estado**) | `fase_clave` + `etiqueta_fase` desde `OptListView` | Texto operativo: Demanda, Cerrada, Pendiente, Lista para cerrar, Lista para armado (OPA), En producción (OPP pendiente), En producción, etc. |
