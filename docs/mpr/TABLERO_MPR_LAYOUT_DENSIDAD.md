...
- **Crear OPP:** `bg-purple-600` (antes azul) para alinear con el acento MPR; **Cerrar** en ámbar por semántica de acción. **Armado** desde enlace global del header (no por OPT).
