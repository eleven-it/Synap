...
| 15 | **Panel «Ya armado» (03/08/2026):** botón **Ya armado** en el chrome oscuro (1 línea `flex-nowrap`); lista Artículo/Packs debajo al expandir. Consolida por `id_articulo_pack`; sin comprobante ni código. Default presentación **Pares** en Armado. |
