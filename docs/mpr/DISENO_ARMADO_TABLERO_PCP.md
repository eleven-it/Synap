...
| 15 | **Panel «Ya armado» (03/08/2026):** colapsable (Alpine `abiertoYaArmado`); vive **dentro del sticky** junto al chrome oscuro para que el toggle no quede tapado; columnas **Artículo** y **Packs**; cantidades **consolidadas por `id_articulo_pack`** (`consolidar_armados_por_articulo_pack`); sin comprobante/PED ni código manual. Toggle **Docenas\|Pares** default **Pares** en Armado. |
