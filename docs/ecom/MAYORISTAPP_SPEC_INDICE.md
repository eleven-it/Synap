...
| 4 | Comprobantes | [SPEC_MAYORISTAPP_COMPROBANTES.md](./SPEC_MAYORISTAPP_COMPROBANTES.md), [SPEC_GESTION_PEDIDOS_SYNAP.md](./SPEC_GESTION_PEDIDOS_SYNAP.md) | Listados v1 + sugerencias N° + no-cancelados/resumen + anulación pedido + checkout PED; hub/menú **Nuevo pedido** → compra Synap | SMTP productivo; UI anular/PDF en grilla |
...
| 8 | Logística y carrito | [SPEC_MAYORISTAPP_LOGISTICA_CARRITO.md](./SPEC_MAYORISTAPP_LOGISTICA_CARRITO.md), [SPEC_ESTADO_PEDIDOS_PREPARACION.md](./SPEC_ESTADO_PEDIDOS_PREPARACION.md), [PLAN_LOGISTICA_LISTA_COMPROBANTES_RUTAS.md](./PLAN_LOGISTICA_LISTA_COMPROBANTES_RUTAS.md), [SPEC_LOGISTICA_LISTA_COMPROBANTES_RUTAS.md](./SPEC_LOGISTICA_LISTA_COMPROBANTES_RUTAS.md), [TEST_LOGISTICA_LISTA_COMPROBANTES_RUTAS.md](./TEST_LOGISTICA_LISTA_COMPROBANTES_RUTAS.md) | **Estado de pedidos:** vista ecom + API + redirect desde catálogo reportes. **Lista comprobantes en rutas:** informe **legacy en módulo `reports`** (`ReportDefinition` + `QueryRunnerService` + pool MySQL unificado + permisos operativos); pendientes envío, geo, jcart | Implementar lista según plan/spec en `reports/`; cerrar relays logísticos restantes + checkpoint `mayoristapp_logistica` |
