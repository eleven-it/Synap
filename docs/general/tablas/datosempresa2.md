...
|---------|-------|-----------|-----------|
| Empresa.frm | 1743 | SELECT | DataEmpresa.RecordSource = "select * from datosempresa2" |
| Funciones.bas | 2894 | SELECT | rs_consulta2.Open "SELECT cuit,id_empresa FROM datosempresa2… |
| Funciones.bas | 2962 | SELECT | rs_consulta2.Open "SELECT cuit,id_empresa,nombre FROM datose… |
