...
- **Rendimiento y error 3024 (BO)**: [docs/reports/BO_REPORT_PERFORMANCE.md](../reports/BO_REPORT_PERFORMANCE.md)
- **BO IMPORTE / CON STOCK IMPORTE**: [BO_REPORT_PERFORMANCE.md](../reports/BO_REPORT_PERFORMANCE.md) § "BO IMPORTE y CON STOCK IMPORTE" (solo PrecioVentaxR; si es 0 es correcto).
- **Pedidos pendientes**: `docs/reports/VALIDACION_PEDIDOS_PENDIENTES.md` (validación de consultas y datos frente a VB6).
- **Ventas netas**: `docs/reports/VALIDACION_VENTAS_NETAS.md` (validación de consultas y datos frente a VB6).
