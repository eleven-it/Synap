...
> **Estado:** Vigente. Los archivos indicados existen en el proyecto (`django_project/firebase_config.py`, `core/views/views.py`, `core/views/views_usuarios.py`, `core/utils/utils.py`, `core/signals.py`, `django_project/auth.py`). Autenticación actual: MySQL vía `login/administranet_auth.py`.
