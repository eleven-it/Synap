...
> **Referencia.** En instalación mínima, pyafipws puede no estar en uso; Self Checkout sí está instalado. Este doc es de diseño y mejora de FE cuando se use pyafipws/WSFEv1.
