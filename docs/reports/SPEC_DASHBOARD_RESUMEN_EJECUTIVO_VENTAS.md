...
**Extensión (may. 2026):** KPI «Vs ayer» con **delta en moneda** además del %; sección **Top 10 productos** (tabla en `lg+`, tarjetas en móvil). Delta OpenSpec: `openspec/changes/executive-dashboard-top10-gap-usd/`.
