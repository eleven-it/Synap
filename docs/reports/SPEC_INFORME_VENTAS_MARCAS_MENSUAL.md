...
**Fijos (sin UI):** `cc.Anulado='No'`, `cc.CodigoMovimiento<>0`, tipos FA/FB/FC/FE/FM + NC*, `st.Anulado='No'`, `st.TipoComp` ∈ Venta / Venta TPV / Devol - Cliente / ND Anul NC, **`articulo.tipo_art = 'Articulo'`** (excluye `Gasto` y `Servicio`, p. ej. «Saldo inicial»).
