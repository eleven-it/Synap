...
- **Auditoría técnica completa (guardado MySQL, tablas, SQL, reglas):** [auditoria_facturas_compras_resumen.md](auditoria_facturas_compras_resumen.md) y documentos enlazados desde allí (`auditoria_facturas_compras_*.md`, JSON de replicación).
