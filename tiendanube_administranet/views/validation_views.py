...
class DataValidationView(TiendanubeAdministranetLoginMixin, PermissionRequiredMixin, TemplateView):
    """
...
class ValidateDataAjaxView(TiendanubeAdministranetLoginMixin, PermissionRequiredMixin, View):
    """
...
class FixInconsistenciesAjaxView(TiendanubeAdministranetLoginMixin, PermissionRequiredMixin, View):
    """
...
class SyncUpdatesAjaxView(TiendanubeAdministranetLoginMixin, PermissionRequiredMixin, View):
    """
