...
**Capability:** `reports-clientes-sin-ventas`  
**Origen:** change `informe-clientes-sin-ventas-vendedor` (archivado 13/07/2026)  
...
Informe operativo/gerencial que lista **clientes activos sin comprobantes en un período**, agrupados por vendedor, con resumen por vendedor y global para gráficos. Accesible en `/reports/dashboard/clientes-sin-ventas-vendedor/` con UI canónica de reportes Synap.
