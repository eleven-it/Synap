# Spec: Mapeo de clientes Tienda Nube

**Capability:** `tiendanube-customer-mapping`  
**Origen:** change `tiendanube-customer-mapping-hardening` (archivado 14/07/2026)  
**Módulo:** `tiendanube_administranet` — flujo New Customer / `CustomerMapping`
