...
### REQ-ED-COB-P1-01 — Detalle cobros

- **`GET .../ventas/cobros/detalle/`** **MUST** devolver filas paginadas con `fecha`, `tipo`, `medio`, `importe`.
- **SHOULD** enriquecer REC con `medio_cobpag` cuando la tabla exista; fallback heurística caja documentado en `meta`.
