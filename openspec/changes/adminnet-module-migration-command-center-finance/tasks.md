...
## P1 — Fuera de esta entrega (solo diseño)

- [ ] P1.1 `tesoreria/banco/resumen/` sobre `librobanco` + `cuenta_banco`.
- [ ] P1.2 `ventas/cobros/detalle/` con `medio_cobpag`.
- [ ] P1.3 `tesoreria/movimientos-caja/` paginado.
