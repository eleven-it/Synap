...
- **`areas.crm`** **MUST NOT** aparecer (CRM deprecado).
...
1. **Dado** usuario gerencial con `base_empresa` válida, **cuando** `GET /api/reports/executive-dashboard/?fecha=2026-05-11`, **entonces** respuesta 200 con `meta.definicion=executive-dashboard-v1` y cinco áreas operativas (sin CRM).
