"""
Configuración temporal para pruebas usando SQLite
"""
import os
...
ROOT_URLCONF = 'django_project.test_urls'
...
# MercadoPago settings for testing
...
# Firebase settings for testing
FIREBASE_CREDENTIALS_PATH = "/tmp/firebase_credentials.json"

# Disable Firebase for testing
import os
os.environ["FIREBASE_CREDENTIALS_PATH"] = "/tmp/firebase_credentials.json" 