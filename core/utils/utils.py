...
APPS_MENU = [
    ...
    {
        "id": "sia",
        "nombre": "Insights Estratégicos y Alineamiento",
        "permiso": "sia.view_company_dashboard",
        "url": "sia:dashboard",
        ...
        "submenus": [
                ...
                "items": [
                    {
                        ...
                        "url": "sia:dashboard",
                        "icon": "dashboard",
                        "permission": "sia.view_company_dashboard"
                    }
                ]
            },
            {
                "seccion": "Ciclos de Evaluación",
                "items": [
                    {
                        "label": "Todos los Ciclos",
                        "url": "sia:evaluation_cycle_list",
                        "icon": "event_note",
                        "permission": "sia.manage_cycles"
                    },
                    {
                        "label": "Crear Ciclo",
                        "url": "sia:evaluation_cycle_create",
                        "icon": "add_circle",
                        "permission": "sia.manage_cycles"
                    }
                ]
            ...
            {
                "seccion": "Respuestas de Encuesta",
                "items": [
                    {
                        "label": "Nueva Respuesta",
                        "url": "sia:survey_response_create",
                        "icon": "note_add",
                        "permission": "sia.create_response"
                    }
                ]
            }
        ]
